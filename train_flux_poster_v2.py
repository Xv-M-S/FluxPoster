...
from image_datasets.poster_dataset_v2 import loader
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(controlnet):
                bs_img, bs_mask_img, bs_mask_hint, bs_caption, bs_texts, bs_bboxes = batch 
                ...
                for img, mask_img, mask_hint, caption, texts, bboxes in zip(bs_img, bs_mask_img, bs_mask_hint, bs_caption, bs_texts, bs_bboxes):
                    img, mask_img, mask_hint = img.squeeze(0), mask_img.squeeze(0),mask_hint.squeeze(0)
                    text_info = auxiliaryPreProcess(img, mask_img, bboxes)
                    ...
                    visual_text_info = preProcess(mask_img, mask_hint, bboxes)
                    ...
                    if visual_text_info is None:
                        ...
                        features = font_embedding.encoder_visual_text_v2(visual_text_info)
                        font_features.append(features)
